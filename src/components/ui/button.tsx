  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:shadow-glow transform hover:scale-105 transition-spring font-semibold",
        glass: "bg-card/10 backdrop-blur-md border border-border text-foreground hover:bg-card/20",
        gradient: "bg-gradient-to-r from-accent to-primary text-primary-foreground hover:shadow-glow",
      },
      size: {
